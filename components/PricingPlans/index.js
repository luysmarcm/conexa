import PricingPlansCard from 'components/Card/PricingPlansCard';
...
const plans = [
	{
		...
		precio: "$200",
		description: {
			text1: "Camiseta, Langer, Taza, Gorra",
			text2: "Certificado.",
			text3: "Asientos en filas intermedia",
		},
	},
	{
		id: "2",
		...
		precio: "$250",
		description: {
			text1: "Camiseta, Langer, Taza, Gorra, Foto conmemorativa",
			text2: "Certificado enmarcado.",
			text3: "Acceso al zona VIP para charla y pregunta.",
			text4: "Asientos en las primeras filas:",
		},
	},
	{
		id: "3",
		...
		<section class="bg-white">
			<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
				...
				<div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
					{plans.map((plan, i) => (
						<PricingPlansCard plan={plan} key={i} />
					))}
