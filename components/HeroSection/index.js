...
import CountdownTimer from "components/CountdownSection/CountdownTimer";
				...
				<div className="p-10 relative flex flex-col items-center w-full mb-10 lg:flex-row space-x-10 justify-around">
					<div className="mb-16 lg:mb-0 lg:max-w-lg lg:pt-20  text-center lg:text-start">
						<div className="max-w-xl mb-6 ">
							<h2 className="text-8xl max-w-lg mb-6 font-bold text-transparent lg:text-9xl bg-clip-text bg-gradient-to-r from-primary via-azul to-secundary tracking-[-6px]">
								Conexa
							</h2>
						...
						<div>
							<div className="flex flex-row space-x-10  items-center justify-center lg:justify-start ">
								<p className=" text-azul text-3xl lg:text-4xl">CARACAS</p>
								<p
									id="content-box"
									className="bg-azul text-2xl lg:text-2xl text-white"
								>
									october <span className="font-extrabold">2023</span>
								</p>
							</div>
